...
module.exports = {
    ...
    /**
     * create an object with the data of a error request
     * @param  {String} message message to return into error object
    ...
    /**
     * create an object with the data of a success request
     * @param  {String} message message to return into success object
